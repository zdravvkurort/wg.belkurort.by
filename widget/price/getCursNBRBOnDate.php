<?php 
if($_SERVER["REQUEST_METHOD"]=="POST" and $_POST['hash'] == "jkdshglsdfoiguosdfignmdfsjhgkshdflgjhdsflkjg"){
	...
	$dog_date = $_POST['date'] ? date('Y-m-d H:i:s',strtotime($_POST['date'])) : date("Y-m-d H:i:s");
