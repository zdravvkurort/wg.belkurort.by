...
УНП 193237911<br/>
====================================================================</p>
<p class = "center">Заявка на аннулирование</p>
<p>ООО «Здравкурорт» в соответствии с заключенным договором просит аннулировать следующие путевки в '.$dog_naimenovanie_obekta_razmescheniya.':</p>
...
'.$turist_4.'<br/>
'.$turist_5.'</p>
<p>Ожидаем письменное подтверждение аннуляции на 
...
$time = date('H:i:s');	
    //$pdf->Output('form.pdf');
	$pdf->Output($card_id.'/'.$date.' '.$time.' Заявка на аннулирование + '.$fio[0].'.pdf');
