...
$document = new PhpOffice\PhpWord\TemplateProcessor('templatesV2/dop_vozvrat.docx'); //шаблон
...
//$sum_vozvr =  $allpay*0.861+(10*find_kurs("USD")["Cur_OfficialRate"]*100/find_kurs("RUB")["Cur_OfficialRate"]);
