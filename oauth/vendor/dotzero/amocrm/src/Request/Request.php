...
class Request
{
    ...
    {	
		...
		$access_token = $this->parameters->getAuth('apikey');
        $headers = [
    ...
    protected function request($url, $modified = null)
    {
        ...
        // curl_setopt($ch, CURLOPT_PROXY, 'socks5h://45.128.205.169:1080');
        // curl_setopt($ch, CURLOPT_PROXYUSERPWD, 'zdravkurort:ZLWzeghShcWr');
